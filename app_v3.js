...
bot.dialog('intentIdentificationDialog',[
    function (session, args) {
      ...
      if (results.response.entity === 'Yes') {
        console.log('Request visit to Liquid Studio.')
        ...
        if (results.response.entity === 'Yes') {
           ...
           emailText = 'On ' + session.conversationData.watsonContext.dateOfVisit + '\n'
            ...
            session.send('Thank you, our team will get in touch regarding your request. ' +
                          +'PLEASE NOTE: this does not constitute a booking, this is a request, someone from Liquid Studio will be in touch with regarding this soon. ')
            session.endConversation()
        } else {
